...
from api.models import Role, Log
...
class RoleViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        Log.objects.create(text='Role created', created_by=request.user)
    ...
    def update(self, request, *args, **kwargs):
        Log.objects.create(text='Role updated', created_by=request.user)
    ...
    def destroy(self, request, *args, **kwargs):
        Log.objects.create(text='Role deleted', created_by=request.user)
